...
contract ERC4973OGiveable is ERC4973O, IERC4973Giveable {
    constructor(string memory name, string memory symbol, string memory version) ERC4973O(name, symbol, version) {}

    function give(address to, bytes calldata signature) external payable returns (uint256) {
